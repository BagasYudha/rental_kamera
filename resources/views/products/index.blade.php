        ...
        <div class="row mt-32">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <a href="{{ route('products.create') }}" class="btn btn-md" style="margin-right: 60px; background-color: mediumslateblue; color: white; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2);">Tambah Produk</a>
                </div>
                <hr>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $product->kategoris ? $product->kategoris->nama : 'Belum ada kategori' }}</td>
